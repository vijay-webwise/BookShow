export default [
  {
    ...
    ua: "6+",
    tickets: [
      { type: "SILVER", price: 299 },
      { type: "GOLD", price: 499 },
    ],
    description:
      "Jump into a world of fun with our state-of-the-art trampoline arena! With interconnected trampolines, wall running, dodgeball courts, and slam dunk zones, it’s the ultimate destination for thrill-seekers of all ages. Perfect for burning energy and creating unforgettable memories.",
  },
  {
    id: 2,
    imageUrl:
